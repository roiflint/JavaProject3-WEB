...
@WebServlet(name = "stockInfoServlet", urlPatterns = "/stockInfo")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (eng.IsStockExist(symbol)) {
                ...
                String json = gson.toJson(eng.getSingleStockInfo(symbol,usernameFromSession,SessionUtils.isAdmin(request)));
                out.println(json);
                out.flush();
            }
            else{
